...
curl -u ${HANA_USER}:${HANA_PASSWORD} "https://${HANA_HOST}:${XS_PORT}/sap/hana/testtools/unit/jasminexs/TestRunner.xsjs?package=com.sap.sapmentors.sitreg.test&format=json" -o test.json
